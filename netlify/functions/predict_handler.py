...
# Function to train the model - directly from app.py
def train_model():
...
def load_model():
    try:
        # Try to load the existing model and scaler
...
# Function to make predictions - directly from app.py
...
if __name__ == '__main__':
    try:
        # Get form data from command line argument
        if len(sys.argv) > 1:
            form_data_str = sys.argv[1]
